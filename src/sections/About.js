  ...
  return (
    <div id="about">
      ...
      <Typography variant="subtitle1" style={{ textAlign: "justify" }}>
        I am a self-taught web developer and Team Treehouse Tech degree
        graduate. I am passionate about building responsive and creating user
        friendly experiences across platforms. I consider myself a lifelong
        learner who strives to be the best version of myself.
      </Typography>
      <br />
        ...
        <Grid item xs={12} sm={6} lg={5}>
          <List>
            <ListItem>
              ...
              <ListItemText
                primary="Degree"
                secondary="BA, Political Science"
              />
            </ListItem>
            <ListItem>
              <ListItemAvatar>
