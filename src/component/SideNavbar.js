    ...
    <div className={'navbar-margin ' + classes.drawerContainer}>
      ...
      <Typography variant='caption' noWrap>
        <div className={classes.withLove}>
          Made with{' '}
          <svg className='heart heart-anim' height="15" viewBox='0 0 32 29.6'>
            <path
